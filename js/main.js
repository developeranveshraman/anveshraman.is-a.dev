...
function enterKey(e) {
  ...
  if (pw) {
    ...
    if (e.keyCode == 13) {
      ...
      git = commands.length;
      addLine("visitor@anveshraman.is-a.dev:~$ " + command.innerHTML, "no-animation", 0);
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "history":
      ...
      break;
    case "email":
      addLine('Opening mailto:<a href="mailto:support@anveshraman.rf.gd">support@anveshraman.rf.gd</a>...', "color2", 80);
      newTab(email);
      break;
    case "clear":
      setTimeout(function() {
